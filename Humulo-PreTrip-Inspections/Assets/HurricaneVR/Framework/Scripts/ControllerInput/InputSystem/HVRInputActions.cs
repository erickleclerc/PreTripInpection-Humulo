...
public partial class @HVRInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""de4d6916-ceb7-4f5f-beb6-105801fc4ecd"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""1c2c712e-f525-4597-a2ae-879082d41e93"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""RightHandJoyStickClick"",
                    ""type"": ""Button"",
                    ""id"": ""14131749-6d0f-4c76-a7ca-68e6ca7ab255"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""675948cb-b87b-471a-b2e4-17ac648e15f1"",
                    ""path"": ""<XRController>{RightHand}/joystickClicked"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""RightHandJoyStickClick"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_LeftHand_LeftJoystickClick = m_LeftHand.FindAction("LeftJoystickClick", throwIfNotFound: true);
        // RightHand
        ...
        m_RightHand_RightHandJoyStickClick = m_RightHand.FindAction("RightHandJoyStickClick", throwIfNotFound: true);
        // HMD
    ...
    private readonly InputAction m_LeftHand_LeftJoystickClick;
    public struct LeftHandActions
    {
        ...
        public InputAction @LeftJoystickClick => m_Wrapper.m_LeftHand_LeftJoystickClick;
    ...
    private readonly InputAction m_RightHand_RightHandJoyStickClick;
    public struct RightHandActions
    {
        ...
        public InputAction @RightHandJoyStickClick => m_Wrapper.m_RightHand_RightHandJoyStickClick;
        ...
        public void AddCallbacks(IRightHandActions instance)
        {
            ...
            @Haptics.performed += instance.OnHaptics;
            @Haptics.canceled += instance.OnHaptics;
            @RightHandJoyStickClick.started += instance.OnRightHandJoyStickClick;
            @RightHandJoyStickClick.performed += instance.OnRightHandJoyStickClick;
            @RightHandJoyStickClick.canceled += instance.OnRightHandJoyStickClick;
        }
    ...
    public interface IRightHandActions
    {
        ...
        void OnControllerRotation(InputAction.CallbackContext context);
        void OnHaptics(InputAction.CallbackContext context);
        void OnRightHandJoyStickClick(InputAction.CallbackContext context);
    }
